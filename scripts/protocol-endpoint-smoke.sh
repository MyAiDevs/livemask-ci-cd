...
# Resolve and activate a real node for HMAC tests
NODE_ID=""
NODE_SECRET=""
NODE_STATUS=""
NODE_SECRET_HASH=""
...
if [[ -n "${NODE_ID}" ]]; then
  ...
  if [[ -z "${NODE_SECRET_HASH}" ]]; then
    ...
    pass "Using real node (${SMOKE_NODE_NAME}): id=${NODE_ID} status=${NODE_STATUS:-unknown}"
  fi
else
...
# ──────────────────────────────────────────────────────────────────────────────
# [23] Runtime log sanity check (backend + nodeagent)
# ──────────────────────────────────────────────────────────────────────────────
echo ""
echo "--- [23] Runtime Log Sanity Check ---"
